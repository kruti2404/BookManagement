...
@Component({
  ...
  templateUrl: './get-template-driven-data.component.html',
  styleUrls: ['./get-template-driven-data.component.css']
})
export class GetTemplateDrivenDataComponent implements OnInit {
  constructor(
  ...
  async getfilteredResult() {
    ...
    await this.SpBookService.FilterBook(formData)
      .then(((response: any) => {
